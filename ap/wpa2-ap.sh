#!/bin/bash
# /home/kali/6csef005w/ap/wpa2-ap.sh
# Start a WPA2-PSK AP with hostapd + dnsmasq on a VM using wlan0.
...
CHANNEL="${CHANNEL:-6}"
WPA2_PASSPHRASE="${WPA2_PASSPHRASE:-6csef005wpass}"  # 8-63 ASCII
